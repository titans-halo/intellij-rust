...
private typealias FragmentConstructor = (Project, String, RsElement) -> RsCodeFragment

abstract class RsCodeFragmentCompletionTestBase(private val fragmentConstructor: FragmentConstructor) : RsTestBase() {
...
private class RsCodeFragmentCompletionTestFixture(
    ...
    private val fragmentConstructor: FragmentConstructor
